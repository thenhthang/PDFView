...
Public Class PrinterUtil
  ...
  End Sub
    ...
    End Sub
    Public Shared Sub PrintImagesToPrinterLookup(ByVal FileName As String, Optional ByVal password As String = "")
        Dim PD As New PrintDialog
        Dim PageCount As Integer = PDFView.ImageUtil.GetImageFrameCount(FileName)
        PD.AllowPrintToFile = True
        PD.AllowSomePages = True
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, _
     ByVal e As PrintPageEventArgs) Handles mPrintDocument.PrintPage
        ...
        Dim RenderDPI As Integer = 300 'Set to 600 if this resolution is too low (speed vs. time) 300 or 600
