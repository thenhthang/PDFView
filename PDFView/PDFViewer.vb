...
#Region "Panning the image with left mouse click held down"
  ...
  End Sub
    ...
    Private Sub tsPrintLookup_Click(sender As Object, e As EventArgs) Handles tsPrintLookup.Click
        If ImageUtil.IsPDF(mOriginalFileName) Or ImageUtil.IsTiff(mOriginalFileName) Then
            PrinterUtil.PrintImagesToPrinterLookup(mOriginalFileName)
        End If
    End Sub
